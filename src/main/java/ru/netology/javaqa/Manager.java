...
public class Manager {
    ...
    public Manager(){}//для установки своего ограничения вывода фильмов

    public String[] findAll () { // вывод ВСЕХ добавленых фильмов. Вообще всех
        return movies;
    }

    public String[] findLast() { // Метод для вывода последних добавленых фильмов (по дефолту или по указаному в ручгую ограничению)
        ...
        for (int i = 0; i < newList.length; i++) { // Для всей длинны массива
